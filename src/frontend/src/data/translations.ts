...
export const translations = {
  it: {
    ...
    registrazioneCompletata1: "Solo un ultimo passo!",
    ...
    registrazioneCompletata4: "Dopo aver confermato l'email,",
    nome: "Nome",
    cognome: "Cognome",
    email: "Email",
    password: "Password",
    ...
    errEmailEsistente: "Email già registrata. Se non hai ancora confermato, controlla la posta, altrimenti accedi.",
    ...
    descrFeat: "Le feature più importanti che influenzano le decisioni del modello. Usa il selettore a lato per scegliere quante visualizzarne.",
  ...
  en: {
    ...
    accedi: "Log in",
    registrati: "Sign Up",
    registrazioneCompletata1: "Just one last step!",
    ...
    registrazioneCompletata4: "After confirming your email,",
    nome: "Name",
    cognome: "Surname",
    email: "Email",
    password: "Password",
    ...
    errEmailEsistente: "Email already registered. If you haven't confirmed it yet, check your inbox, otherwise log in.",
    ...
    descrFeat: "The most important features that influence the model's decisions. Use the side selector to choose how many to display.",
  ...
  es: {
    ...
    registrazioneCompletata1: "¡Solo un último paso!",
    ...
    registrazioneCompletata4: "Después de confirmar tu correo electrónico,",
    nome: "Nombre",
    cognome: "Apellido",
    ...
    errEmailEsistente: "Correo electrónico ya registrado. Si aún no lo has confirmado, revisa tu bandeja de entrada, de lo contrario, inicia sesión.",
    ...
    descrFeat: "Las características más importantes que influyen en las decisiones del modelo. Usa el selettore a lato per scegliere quante visualizzarne.",
  ...
  ar: {
    ...
    accedi: "تسجيل الدخول",
    registrati: "تسجيل",
    registrazioneCompletata1: "خطوة أخيرة فقط!",
    ...
    registrazioneCompletata4: "بعد تأكيد بريدك الإلكتروني،",
    nome: "الاسم",
    cognome: "اللقب",
    ...
    errEmailEsistente: "البريد الإلكتروني مسجل بالفعل. إذا لم تقم بتأكيده بعد، تحقق من البريد الوارد، وإلا قم بتسجيل الدخول.",
  ...
  notte: "داكن",
    ...
    descrFeat: "أهم 10 خصائص تؤثر على قرارات النموذج. استخدم المحدد الجانبي لاختيار عدد الخصائص المراد عرضها.",
