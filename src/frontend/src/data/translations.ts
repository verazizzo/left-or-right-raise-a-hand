...
export const translations = {
  it: {
    ...
    welcomeDesc: "Come funziona davvero il cervello umano? Cosa succede esattamente nei nostri tracciati quando pensiamo di alzare un braccio o l'altro? ",
    welcomeDesc2:"Scoprilo con noi esplorando i dati attraverso modelli avanzati e visualizzazioni interattive. Analizza i risultati ottenuti su diversi utenti per spiegare come l'IA interpreta ogni singolo movimento.",
    //FRASI POPOLAZIONE
    ...
    aboutContent3: "L'IA è stata addestrata con validazione LOGO (Leave-One-Group-Out) per testare la generalizzazione su nuovi pazienti. È stato usato un classificatore SVM con iperparametri ottimizzati per ciascun utente.",
  ...
  en: {
    ...
    welcomeDesc: "How does the human brain really work? What exactly happens in our traces when we think about raising one arm or the other?",
    welcomeDesc2: "Discover it with us by exploring the data through advanced models and interactive visualizations. Analyze the results obtained from different users to explain how AI interprets every single movement.",
    //FRASI POPOLAZIONE
  ...
  es: {
    ...
    welcomeDesc: "¿Cómo funciona realmente el cerebro humano? ¿Qué sucede exactamente en nuestros trazados cuando pensamos en levantar un brazo o el otro? ",
    welcomeDesc2: "DDescúbrelo con nosotros explorando los datos a través de modelos avanzados y visualizaciones interactivas. Analiza los resultados obtenidos de diferentes usuarios para explicar cómo la IA interpreta cada movimiento.",
    //FRASI POPOLAZIONE
  ...
  notte: "داكن",
    ...
    welcomeDesc: "كيف يعمل الدماغ البشري حقًا؟ ماذا يحدث بالضبط في مخططاتنا عندما نفكر في رفع ذراعنا اليمنى أو اليسرى؟",
    welcomeDesc2: "اكتشف ذلك معنا من خلال استكشاف البيانات عبر نماذج متقدمة ومرئيات تفاعلية. قم بتحليل النتائج التي تم الحصول عليها من مستخدمين مختلفين لشرح كيفية تفسير الذكاء الاصطناعي لكل حركة.", 
